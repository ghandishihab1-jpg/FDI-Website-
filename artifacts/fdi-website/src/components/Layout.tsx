...
import logoPath from "@assets/44425E6A-9426-487B-93F0-FF6FB9B2DAEC_1778262613352.jpeg";
    ...
    <div className="min-h-screen flex flex-col bg-background font-sans rounded-none">
      ...
      <div className="bg-white text-xs py-2 px-4 sm:px-6 lg:px-8 border-b border-border flex justify-between items-center" data-testid="top-strip">
        ...
        <div className="flex gap-4 text-muted-foreground">
          ...
          <a href="mailto:fdi.jo123@gmail.com" className="hover:text-foreground">Email fdi.jo123@gmail.com</a>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex flex-col space-y-2">
              ...
              <Link href="/venue" className="text-sm text-gray-300 hover:text-white transition-colors">Venue</Link>
            </div>
          </div>

          <div>
            <h3 className="text-lg font-serif mb-4">Write to Us</h3>
            <form className="space-y-3" onSubmit={(e) => e.preventDefault()} data-testid="footer-form">
              <input 
                type="text" 
                placeholder="Name" 
